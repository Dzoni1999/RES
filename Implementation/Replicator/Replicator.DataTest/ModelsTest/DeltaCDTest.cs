                ...
                new List<CollectionDescription>
                {
                    new CollectionDescription(
                        ...
                        new HistoricalCollection(
                            ...
                            {
                                new ReceiverProperty(ECode.CODE_ANALOG, int.MinValue),
                                new ReceiverProperty(ECode.CODE_ANALOG, int.MaxValue),
                                new ReceiverProperty(ECode.CODE_DIGITAL, 0),
                                new ReceiverProperty(ECode.CODE_CUSTOM, 1),
                            }                   
                                                )
                                             )
                },
