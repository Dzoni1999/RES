...
namespace Reader.Services
{
    public class ReaderSvc : IReader
    {
        ...
        public string ReadDataFromDataBase(ECode c, int datasetID, ReplicatorDbContext _context, string dateFrom, string dateTo)
        {
